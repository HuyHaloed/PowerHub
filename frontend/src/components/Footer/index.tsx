        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              Nền tảng đặt lịch khám bệnh trực tuyến hàng đầu Việt Nam, kết nối bệnh nhân với đội ngũ bác sĩ chuyên môn cao.
            </p>
          ...
          {/* Specialties */}
          <div>
            <h4 className="text-lg font-semibold text-white mb-4">Chuyên khoa</h4>
            <ul className="space-y-2">
              {specialties.map((specialty, index) => (
                <li key={index}>
                  <Link
                    to={`/search?specialty=${specialty.value}`}
                    className="text-gray-400 hover:text-white transition-colors"
                  >
                    {specialty.label}
                  </Link>
